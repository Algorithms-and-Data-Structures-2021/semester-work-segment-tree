...
- **Основные операции:**/n
    ...
    /nII Запрос минимума (запрос максимума выполняется аналогично).
    ...
    IV Запрос изменения отрезка в x раз.
...
| :---                      | ---                                     | :---            |
| `benchmarks.cpp`          | Именно тут нахоятся замеры врмени работы основных шести 
функций: создание дерева, запрос максимума/минимума, запрос обновления занчения, запрос обновления значения на отрезке в Х раз, запросс суммы.| _время_         |
